...
const NotificationPanel = ({ notifications, onClear, onRemove }: NotificationPanelProps) => {
  ...
  return (
    <div className="relative">
      ...
      {/* Notification Panel */}
      {isOpen && (
        <Card className="absolute left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-0 top-12 z-50 w-[calc(100vw-2rem)] sm:w-80 max-w-80 border-0 bg-card shadow-large">
